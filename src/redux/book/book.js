...
export const getBooks = createAsyncThunk(GET_BOOK, async (post, { dispatch }) => {
  const response = await fetch('https://us-central1-bookstore-api-e63c8.cloudfunctions.net/bookstoreApi/apps/H4FoRmCLXgSo5vN3DZyK/books');
...
const addBook = createAsyncThunk(ADD__BOOK, async (book, { dispatch }) => {
  await fetch('https://us-central1-bookstore-api-e63c8.cloudfunctions.net/bookstoreApi/apps/H4FoRmCLXgSo5vN3DZyK/books', {
    method: 'POST',
...
const removeBook = createAsyncThunk(REMOVE__BOOK, async (id, { dispatch }) => {
  await fetch(`https://us-central1-bookstore-api-e63c8.cloudfunctions.net/bookstoreApi/apps/H4FoRmCLXgSo5vN3DZyK/books/${id}`, {
    method: 'DELETE',
  });
  dispatch({
    type: REMOVE__BOOK,
